  ...
  return (
    <div className="space-y-5">
      ...
      <HeroPicker
        ...
        maxAbsolute={20}
        title="Hero photos"
        hint="Drag-rank up to 16 photos for this country. Personal photos from your pins across the country land here, labeled with the city name where each was shot."
      />

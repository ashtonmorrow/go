...
**Resolved 2026-05-13:** all 4 Priority-0 errors, all 20 Priority-1 errors, and most Priority-2 structural items. Remaining work is hotel-pin selection (Bruges where-to-stay table, Alicante where-to-stay table) and editorial judgment items (Kusttram retitle vs split, The Hague SEO title pattern, photo hero picks). Saved-list dedup also resolved separately (Bristol, Den Haag, Santiago de, Cordoba rename).

### Priority 0 — facts wrong enough to block indexable

- [x] **athens.md** — the Acropolis combo ticket was **discontinued April 2025**. The whole "Acropolis pass" section is built around something that no longer exists. Single-site Acropolis is €30 (high) / €15 (low). National Archaeological Museum is **€20 as of Jan 2026** (file says €12). Daphni Monastery is **free**. Aegina ferry round-trip is closer to €20-€25 conventional (file says €15). Combo claim for Daphni / Hosios Loukas / Nea Moni is wrong — they share a UNESCO inscription, not a ticket. Section needs a rewrite, not a patch.
- [x] **barcelona.md** — multiple geographic errors. Grand Hyatt is in **Pedralbes** (L3 Maria Cristina), not Diagonal Mar / L4. Four Points by Sheraton Diagonal is in **Poblenou/Glòries**, not "around La Rambla." Durlet Beach Apartments is on **Rambla del Poblenou** (a different Rambla), not the end of La Rambla. Hyatt Regency Tower is in L'Hospitalet and the "walk to airport" claim is wrong (5 km industrial). Sagrada Família is on **L2 (purple) and L5 (blue)**, not L1. T-Casual is **virtual-only via T-Mobilitat NFC** in 2026, not a paper card. L9 Sud requires the **€5.90 Bitllet Aeroport** (T-Casual not valid). Aerobús (~€7.75) is omitted entirely. €30 taxi quote is below the current ~€39 fixed rate. Sitges by Rodalies is 35-38 min, not 45. Renaissance Fira: vertical garden, not "hanging gardens."
- [x] **rotterdam.md** — Kinderdijk Waterbus Line 202 **does not exist in 2026**. Rebranded as WaterShuttle (Fri/Sat/Sun only, €9.75 single / €19.50 return, no OVpay). Body, FAQ, and table all carry the stale claim. Depot Boijmans is **€20**, not €23. Erasmusbrug pin link points to `/cities/rotterdam` (broken). Witte Huis is "Europe's first high-rise," not "first skyscraper."
- [x] **khao-yai.md** — park hours are **08:00-17:00**, not 06:00-18:00 (wrong twice, body + FAQ). Haew Narok is **150 m**, not 80 m. **Pha Diao Dai closes annually June 1 - Sep 30** — missing from writeup. Park entry fee is 400 THB for foreign adults (the "400 to 500" range needs a source).

### Priority 1 — material factual errors

- [x] **alicante.md** — ALC is Spain's **5th-busiest** airport (18.3M pax), not 3rd. "More sunshine than any continental European **capital**" — Alicante is not a capital, should be "city."
- [x] **the-hague.md** — Mauritshuis €4-after-4pm is **Netherlands residents only** in 2026 (body + FAQ). Queen Emma is Willem-Alexander's **great-great-grandmother** (4 generations), not great-grandmother. Binnenhof "world's oldest parliament still in use" overstates; should be "one of the oldest." Strandhuisjes Kijkduin are seasonal rentals, not "rebuilt every summer." Tsar Nicholas II at Hotel Des Indes — verify; the documented guest list is Pavlova / Empress Sisi / Roosevelt / Mata Hari.
- [x] **london.md** — Sky Garden is on the **43rd floor** (bars on 35-37), not "35th floor." citizenM Tower of London: **2 lines** (Circle + District), not 3 — DLR's Tower Gateway is a 4-min walk away. Crowne Plaza Docklands: Jubilee Line **requires a transfer at Canning Town** — nearest direct is Elizabeth (Custom House) and DLR (Royal Victoria). Heathrow Express walk-up is £25/£32, not £25-£37.
- [x] **split.md** — Bus 37 to Trogir: **50-60 minutes** (file says 30), fare ~€2.50 (file says €4). "Pleso Prijevoz" is a **Zagreb** operator name — Split airport bus is Promet Split. Temple of Jupiter is **adjacent to Peristyle** (1-min walk), not "5-min walk north." St. Martin's Church is **5th-6th century**, not 7th. Marjan Hill and Trogir links both point to `/cities/split` (self-link broken; Trogir should be `/cities/trogir`).
- [x] **trogir.md** — Split Airport (SPU) is **4 km** from the old town, not "a few hundred metres." Body H2 case inconsistent ("A Half-Day Shape" vs "A morning in the old town").
- [x] **cabo-verde.md** — North American route is **Providence, RI (PVD)** since 2024, not Boston (TACV Boston suspended). Chã das Caldeiras population is ~700-1,000, not "around 1,500." Distance to Senegal is ~570 km, not 450 km.
- [x] **djerba.md** — DJE airport is **southwest** of Houmt Souk (Mellita), not southeast. Mainland from Djerba is **15-20 min** Ajim-Jorf ferry OR the El Kantara causeway (no ferry); the "90-minute ferry" claim is wrong. Djerbahood: **150 artists / 30+ countries / 250+ murals** — guide_card says "250+ artists" (swap).
- [x] **santiago-chile.md** — Bip! card is **required** for the metro (single-use paper tickets aren't standard); file frames it as a discount. La Chascona is **8,000 CLP** (~$10), not 7,500. Mercado Central roof is **cast-iron** (Glasgow-built 1872), not "wrought-iron." Concha y Toro pricing is stale (premium tours run $80-128).
- [x] **montevideo.md** — Colonia del Sacramento link points to `/cities/montevideo` (broken). FAQ frontmatter has a duplicate `a_text:` field that shouldn't be there (stale schema artifact).
- [x] **kuala-lumpur.md** — KLIA Ekspres runs every **20 minutes** (file says 15-20). **Kelana Jaya is LRT, not MRT** (the MRT lines are Kajang and Putrajaya). **Dark Cave at Batu Caves closed since 2019** — should not be listed as a current add-on.
...
- [x] **chiang-mai.md** — **Thai Smile no longer operates** (reabsorbed into Thai Airways early 2024). Cannabis legal status: reclassified as controlled herb mid-2025 — verify framing before indexable.
- [x] **koh-samui.md** — **There is no Park Hyatt on Koh Samui**. The luxury anchors are Six Senses, Vana Belle (Luxury Collection), Kimpton Kitalay Samui, W Koh Samui. Mu Ko Ang Thong departures are from **both Nathon and Bophut** (file says Nathon only). Authoring-notes block missing.
- [x] **bangkok.md** — Grand Palace closes the gate at 15:30 but **last admission is 15:00**. Bangkok National Museum is ~10-12 min walk from the Grand Palace, not 5.
- [x] **phuket.md** — Big Buddha row in cultural circuit links to `/pins/paradise-viewpoint` — Paradise Viewpoint is above Paradise Beach (south of Patong), unrelated to Big Buddha. Mismatch; split or rename.
- [x] **singapore.md** — Changi Airport to City Hall requires **changing at Tanah Merah** (East-West Line / Changi branch). Helix Bridge pin link points to `/cities/singapore` (self-link). "Easiest airport in the world" is the kind of unsupported superlative CLAUDE.md voice rules call out.
- [x] **gunung-mulu.md** — "Four daily MASwings flights" is from Miri, not from each city; rephrase as "four daily across the three hubs, Miri the most frequent." Spelling "MasWings" → **MASwings** (official cap). Flag in authoring notes: MASwings was **acquired by AirBorneo Jan 2026**, routes transitioning.
- [x] **kota-kinabalu.md** — Shangri-La's Tanjung Aru rebranded as **Shangri-La Tanjung Aru, Kota Kinabalu** (no apostrophe-s). Mount Kinabalu climb permits are no longer Sutera Sanctuary Lodges only; the booking concession changed.
- [x] **bruges.md** — Brussels-to-Bruges single is **€17.60** (and 50% off on weekends with the Weekendticket), not €17/€33-day-return. Antwerp-to-Bruges direct exists at ~75 min.
- [x] **amsterdam.md** — Schiphol is **9-10 km SW** of Centraal, not 15 km. Zaanse Schans walk is **15 min** across the Julianabrug, not 10. "Spoor" (line 28) is the Dutch word for track/platform, not a place name — lowercase or rephrase.
...
- [x] **koh-samui.md** and **ho-chi-minh-city.md** — authoring-notes blocks missing. CLAUDE.md requires one on every list scaffold.
- [x] **cordoba-ar.md** — no "On this page" anchor list. Inconsistent with other scaffolds.
- [x] **trogir.md**, **balkan-green-markets.md**, **kusttram-stations.md** — body H2 title-case vs sentence-case inconsistency (e.g., "A Half-Day Shape" vs "A morning in the old town").
- [x] **kuala-lumpur.md** — Sheraton "skip" row mixed into the recommended where-to-stay table. CLAUDE.md: avoid-hotels go in their own "Hotels I would definitely avoid" section.
- [x] **split.md** — same issue: "Inside the palace" and "Mall of Split / suburbs" rows warn-to-avoid inside the recommended table.
- [x] **alicante-metro-stops.md** — stretches table mixes L1 (limited stops to Benidorm) with L3 (all stops through Coveta Fumà / Cala Piteres). Add a "Line" column or split the table.

### Pin-link cleanup (separate audit pass)

- [x] Slug typo: `war-remnants-musem` → `war-remnants-museum` (Vietnam). Renamed in Supabase 2026-05-13 and body link updated.
- [x] Self-links to fix: split.md (Marjan Hill, Trogir row → /cities/trogir), singapore.md (Helix Bridge → plain text), montevideo.md (Colonia → plain text), rotterdam.md (Erasmusbrug → plain text). All fixed 2026-05-13.
...
- [ ] Mismatch: `ben-dinh-tunnels` in body labeled "Cu Chi Tunnels". Body now distinguishes Ben Dinh vs Ben Duoc; rename pin to `cu-chi-tunnels-ben-dinh` if you want a more descriptive slug, otherwise leave.

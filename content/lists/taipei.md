...
indexable: false
featured: true
title: "Taipei travel guide: the Houtong cat village day trip and the noodle picks"
headline: "Taipei, the noodle city with a cat-village day trip"
description: "My Taipei travel guide. The Houtong Cat Village day trip on the Pingxi line, the beef-noodle and homemade-noodle stops, and a quiet canal walk."
...
# - 2026-05-20: Written from the taipei saved_list (5 pins) plus Mike's
#   lived notes on Houtong Cat Village. Background facts on Houtong's
#   mining history and the 2008 Peggy Chien turning point sourced from
#   Wikipedia and Lonely Planet. Verify the train timings before each
#   republish, the Pingxi Line schedule drifts.
# - indexable: false until Mike reviews. Mike has photos for Houtong
#   on the pin already (hero_photo_urls populated). Drop in additional
#   shots via /admin/pins/houtong-cat-village if he wants a richer page.
# - Pins linked: houtong-cat-village, niou-dien-beef-noodles,
#   lao-shandong-homemade-noodles, chef-hung-beef-noodle-soup-taipei-
#   taiwan, wulixue-irrigation-canal. All on the taipei saved_list as
#   of this commit.
# - 2026-05-20: Folded the old 'taipei, close & cheap' saved_list into
#   'taipei'. Also pulled in Houtong (was on 'random saves'), Chef Hung,
#   and Wulixue (both had Taipei city tag but no saved_list).
# - Taipei city page exists at /cities/taipei.
# - SEO title leads with "Taipei travel guide" per the audited Semrush
#   pattern. The Houtong hook is the differentiator since the cat-
#   village query is its own large keyword cluster.
---

[Taipei](/cities/taipei) is the capital of Taiwan, a dense, walkable city on the north end of the island with an MRT that covers everything, food at every price point, and a serious set of day trips out into the Keelung mountains. This list focuses on what I actually went to: the Houtong Cat Village day trip on the Pingxi line, three noodle stops in town, and a small canal-side walk.

## On this page

* [Getting in from TPE](#getting-in-from-tpe)
* [The Houtong Cat Village day trip](#the-houtong-cat-village-day-trip)
* [Where to eat](#where-to-eat)
* [A quiet walk along the Wulixue canal](#a-quiet-walk-along-the-wulixue-canal)
...
|---|---|---|
| [Niou Dien Beef Noodles](/pins/niou-dien-beef-noodles) | The beef-noodle bowl, casual sit-down room | ~NT$200 (~$6 USD) |
| [Lao Shandong Homemade Noodles](/pins/lao-shandong-homemade-noodles) | Hand-pulled-noodle spot with a Shandong-province lean | ~NT$150 to $250 (~$5 to $8 USD) |
| [Chef Hung Beef Noodle Soup](/pins/chef-hung-beef-noodle-soup-taipei-taiwan) | The Michelin-recognized chain version of the dish, slightly fancier room | ~NT$300 to $500 (~$10 to $16 USD) |
...
[Wulixue Irrigation Canal](/pins/wulixue-irrigation-canal) is the small canal-side park in the city, a short walk where you trade the noise for a quieter Taipei. It is the kind of stop that does not show up in the standard guidebook lists but works well as a break between MRT-driven sightseeing days.

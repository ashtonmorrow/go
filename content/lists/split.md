...
guide_cards:
  ...
  cards:
    ...
    - title: Diocletian's Palace is the morning walk
      body: Peristyle, Cathedral of St. Domnius, Temple of Jupiter, Vestibule, the basement halls. Two hours if you skip the climb up the bell tower, three with it. Do it before 11 a.m. to beat the cruise-ship arrivals.
    - title: Marjan Hill for the half-day
      body: The forested peninsula west of town. 178 m to the viewpoint at Telegrin, a 90-minute round-trip walk with a stop at the small medieval churches along the way. Free.
    - title: Hvar or Brač for the day trip
      body: Hvar is the party island with the better food scene. Brač has Zlatni Rat (the famous shifting-tip beach) and a quieter rhythm. Jadrolinija ferries to both leave several times a day from the Split harbor.
...
These are working notes from real time on the ground rather than a checklist. Split rewards going slowly more than it rewards covering ground. Take what's useful, skip the rest.
...
* [Day trips and ferries](#day-trips-and-ferries)
...
[Historical Complex of Split with the Palace of Diocletian](/pins/historical-complex-of-split-with-the-palace-of-diocletian) is the UNESCO core. A two- to three-hour walking circuit covers the headlines.

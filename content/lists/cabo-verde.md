...
guide_cards:
  ...
  cards:
    ...
    - title: Inter-island is by plane or ferry
      body: Cabo Verde Airlines and TACV run regional flights between the islands. Ferries also exist but are weather-dependent and irregular. Book the flight unless you have flexibility. Connect Sal or Praia for most onward routes.
    - title: November to June is the window
      body: Tropical climate with a short wet season from August to October. November to June is dry, sunny, and reliable. The trade winds keep the heat manageable. Bring layers for the hike islands (Fogo, Santo Antão get cool at altitude).
    - title: Don't skip Mindelo
      body: The cultural capital of the country. The Morna and Funaná music traditions are alive in the bars (especially during the Baía das Gatas festival in August). Mindelo is the right base for one or two slower days that are not about beaches.
...
faqs:
  ...
  - q: Is it safe?
    a: Yes, by general travel standards. The usual urban precautions in Praia and parts of Mindelo at night. Small-town and resort areas are very calm. Most travelers report Cabo Verde as one of the easier West African destinations.
...
#   pattern for cross-island content. If Mike prefers, this could be
#   moved to /content/posts/cabo-verde-travel-notes.md as an article
#   instead of a list scaffold.
# - Source: Mike's Cabo Verde travel brief. Personal references
#   stripped.
---

...
guide_cards:
  ...
  cards:
    ...
    - title: Pick a base by the trip
      body: Houmt Souk for the medina and walkable culture. Midoun for resort beach access. Aghir for quiet beachside. Erriadh if you want to live inside the street art project. Tezdaine for a calmer apartment between Midoun and the sand.
...
faqs:
  - q: How do I get to Djerba?
    a: Djerba-Zarzis International Airport (DJE) is the gateway, about 9 km from Houmt Souk. Direct seasonal flights run from several European cities (Paris, Lyon, Geneva, Brussels, Munich); from Tunis there are multiple daily Tunisair flights of about an hour. From North America the cleanest play is to connect through Paris or Frankfurt.
  - q: Do I need a visa?
    a: Most Western passports enter Tunisia visa-free for up to 90 days. US, UK, and EU travellers are covered. Check the current rules at the embassy before travel; the policy has shifted a few times in recent years.
  - q: Is Djerba safe for travellers?
    a: Generally yes. The standard precautions apply; keep cash and passport in a hotel safe, pre-arrange airport transfers, do not engage with persistent street vendors. The island is more relaxed than mainland Tunisia and has a long tradition of pluralism (the El Ghriba synagogue is one of the oldest in the world and remains active).
...
* [El Ghriba and Djerbahood](#el-ghriba-and-djerbahood)
* [Daytrip to Matmata](#daytrip-to-matmata)
...
Houmt Souk is the working town of the island. The medina is genuinely active rather than staged: a fish market that runs early-morning auctions, narrow alleys with local jewellers and spice merchants, and a handful of small restaurants that do real Tunisian food.
...
For lunch, brik (the thin pastry with egg and tuna), couscous, and grilled fish are the three plates to order. The corner restaurants on the medina edge serve all three honestly for 15 to 25 TND a head.
...
The Star Wars set is the headline, but the surrounding villages and the broader troglodyte landscape are the real reason to make the trip. The dwellings are genuinely lived in; most are still family homes.

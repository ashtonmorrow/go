...
#   Candidates: the abbey + Pulteney Weir composition, the rooftop pool
#   at Thermae Bath at golden hour, the Royal Crescent.
# - related.city / related.country: /cities/bath exists in go_cities;
#   the country slug for the UK in this atlas should be verified.
#
# - Pins linked from this scaffold (all confirmed in the atlas):
#     · hotel-indigo-bath (new in this pass; 4 South Parade, indexable:false)
#     · bathwick-boatman (5/5; Forester Rd, Sunday roast pick)
#     · thermae-bath-spa (Bath-UK + spa-day saved_list)
#     · the-roman-baths (Bath-UK + spa-day saved_list)
#     · pulteney-weir (no address yet; surface stop)
#     · bath-guildhall-market (Guildhall Market BA2 4AW)
#     · cote-salisbury (5/5; Salisbury, on /lists/salisbury-stonehenge)
#     · wagamama-salisbury (5/5; wired onto the salisbury list this pass)
#     · salisbury-cathedral
...
#   %26 encoding and breaks if anything URL-parses it twice. Old slug
#   added to next.config.js legacyListSlugs so any pre-rename bookmark
#   continues to resolve.
#
# - Pins added to the salisbury & stonehenge saved_list this pass:
#     · wagamama-salisbury (5/5, was not on the list; surfaces it on
#       the /lists/salisbury-stonehenge grid)
#     · stonehenge-avebury-and-associated-sites (the UNESCO ref pin;
#       was not on the list)
#
# - Spelling note: British English used throughout. The page is about
#   a British destination so the standard rule applies; "centre",
...
* [The Roman Baths and Thermae Bath Spa](#the-roman-baths-and-thermae-bath-spa)
* [Stonehenge as the Bath-Salisbury add-on](#stonehenge-as-the-bath-salisbury-add-on)
* [Where to eat in town](#where-to-eat-in-town)
...
The underrated part of Bath is the river. [Pulteney Weir](/pins/pulteney-weir) is the horseshoe-step weir directly below Pulteney Bridge in the centre, and the spillway that puts the abbey in the foreground of every postcard photograph of the city. Stand on the bridge, walk down to the lower terrace, then cross to the Bathwick side and pick up the towpath of the Kennet & Avon Canal.
...
Coming back into town, swing through the Royal Crescent and the Circus on the way back to South Parade for the photogenic Georgian terraces, then through the centre to dinner.
...
- [The Roman Baths](/pins/the-roman-baths) is the museum: the first-century AD Roman complex with the Sacred Spring still bubbling at the centre and the Great Bath still full of warm green water you walk around but cannot enter. About 90 minutes with the audio guide. Worth doing first; the bathing next door makes more sense after.
- [Thermae Bath Spa](/pins/thermae-bath-spa) is the modern bathing complex, open 9 a.m. to 9 p.m., book the timed entry online. The rooftop pool over the city is the one that earns the visit and is the right call regardless of weather; rain on warm thermal water is part of the appeal rather than a problem.

Both sit on Stall Street in the centre, about a hundred metres apart. The afternoon-museum-then-evening-spa shape is the one I would book.
...
The train: GWR from Bath Spa to Salisbury runs frequently, takes about an hour, sometimes direct and sometimes with a Westbury change depending on the service. Salisbury station drops you a short walk from the cathedral close and the centre.
...
| Spot | Best for | Where |
|---|---|---|
| [Bathwick Boatman](/pins/bathwick-boatman) | The Sunday roast on the river. Book in advance; this is the trip-builder meal of the guide | Forester Road, Bathwick |
| [The Pump Room Restaurant](/pins/the-pump-room-restaurant) | Afternoon tea in the eighteenth-century Pump Room with the spring water on tap. Touristy but worth it once | Stall Street, attached to the Roman Baths |
| [Clayton's Kitchen](/pins/clayton-s-kitchen) | A modern British dinner inside the centre. Reliable, fair price for the menu | 15A George Street |
| [The Circus Restaurant](/pins/the-circus-restaurant) | Small bistro a few doors off the Circus, useful for a quiet dinner away from the centre crowd | Near the Circus terrace |
| [Bath Guildhall Market](/pins/bath-guildhall-market) | The small indoor market by the abbey. Sandwich, coffee, a quick lunch between sights | Guildhall Market, BA2 4AW |

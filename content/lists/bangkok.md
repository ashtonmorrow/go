...
Most central Bangkok hotels are about an hour by road from either airport, give or take traffic. Plan that into your arrival day rather than assuming you will check in 20 minutes after wheels-down.
...
Bangkok in general is still a more cash-driven city than most travelers expect. ATMs are everywhere and the airport ones are fine; pull a few thousand baht on the way out so taxi tolls, street food, and the inevitable small-stall purchase are not friction.

[Don Mueang (DMK)](/pins/don-mueang-international-airport) is the older airport and serves most of the low-cost regional carriers. Taxi or Grab is the cleanest move from there; the SRT Red Line train works but is slower with luggage.

### Worth knowing for an early flight

If you have a 6 a.m. departure, the easy answer is the [Hyatt Regency Bangkok Suvarnabhumi](/pins/hyatt-regency-bangkok-suvarnabhumi-airport). It is older but solid: large pools, an outdoor bar, a couple of restaurants, FoodPanda delivery if those are closed by the time you check in, and a walk-over to the terminal in the morning. The walk has a few curbs to negotiate with luggage, but it is short and beats fighting the airport at 4 a.m. with an Uber.
...
If you arrived on a long-haul flight and the temple circuit is too much for the first morning, Bangkok solves this problem better than most cities: you can spend the day walking from one mall to the next without ever leaving the BTS spine and without ever being outside in the heat for very long. The malls are connected to the train, the train is air-conditioned, and the malls themselves run from older and weirder to newer and slicker as you move east. When I take someone new to Bangkok on a low-impact first day, this is the route I run.
...
The whole sequence runs about 6 km west to east on the BTS Sukhumvit line. You can do as much or as little of it as you have energy for. If the goal is just to be in air conditioning and eat well, MBK plus the Em District alone is a reasonable day.
...
I would not build a trip around tuk-tuks. Take one once if you want to. Use BTS, MRT, ferries, and Grab for the rest.

I would not chase floating markets on a short Bangkok trip. The famous ones are now staged for tourists and the round-trip eats a half-day.

I would not stay near Khao San unless that is specifically the trip you want. The street is loud, the rooms are usually a step down, and you are far from BTS and the river.

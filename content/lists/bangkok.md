...
| **Yi Peng** | Same date as Loy Krathong | The northern Lanna sky-lantern release. Bangkok runs a smaller version, but the main event is up in [Chiang Mai](/lists/chiang-mai). If sky lanterns are the trip, base in Chiang Mai for the November window |
...
| Thong Lo (Thonglor) | BTS Thong Lo | Dense food and bar scene along Soi 55. [The Commons](/pins/the-commons-thonglor), [She Bar](/pins/she-bar) | Further out, so you Grab to Asoke and Siam more often than from Phrom Phong |
| Silom / Sathorn | BTS Sala Daeng / MRT | Business district by day, [Lumpini Park](/pins/lumpini-park) at the door, calmer evenings | Less of a buzzy night neighborhood than Sukhumvit |
...
| [Khao San Road](/pins/khao-san-road) | No BTS. Grab in | Backpacker Bangkok if that is specifically the trip | Loud, chaotic, far from BTS and river. Visit at night, do not sleep here |
...
| [Sindhorn Midtown (IHG Vignette Collection)](/pins/sindhorn-midtown-hotel-bangkok-vignette-collection-by-ihg) | Langsuan / Lumpini | Newest property of the bunch. Spacious rooms with high-rise views, 18th-floor pool, breakfast rivals any hotel in the city, on-site cafe open until 10 p.m. with fair prices, 24-hour 7-Eleven next door | Premium tier inside the IHG portfolio, so points-redemption math is different |
| [InterContinental Bangkok](/pins/intercontinental-bangkok) | Phloen Chit / Chit Lom | The older IHG flagship in Bangkok. Connected by skybridge to Gaysorn Village and CentralWorld, BTS Chit Lom at the door. A reliable upscale base if you want central-shopping convenience without a hike to the train | Older property, so the rooms and finishes are not the newer-build feel of the Sindhorn |
...
|---|---|---|---|---|
| 1 | [MBK Center](/pins/mbk-center) | National Stadium | Independent stalls, electronics, tailoring, sprawling Thai food court | Old-school, chaotic, cheap |
| 2 | [Siam Center](/pins/siam-center) + [Siam Paragon](/pins/siam-paragon) | Siam | Thai streetwear and designer brands (Center). Luxury and SEA LIFE aquarium (Paragon) | Connected by skybridge from MBK |
| 3 | [CentralWorld](/pins/centralworld) | Chit Lom | Largest mall in the center, mainstream brands, big food hall. [% Arabica](/pins/arabica-bangkok-central-world) on the ground floor | Mainstream, easy on a tired afternoon |
| 4 | Em District: [Emporium](/pins/emporium-bangkok), [EmQuartier](/pins/emquartier), [Emsphere](/pins/emsphere) | Phrom Phong | Newest cluster, best food halls, EmQuartier's Helix dining levels, Emsphere's rooftop EM Wonder | Polished, busy bar scene after dark |
...
|---|---|---|---|
| [Chatuchak Weekend Market](/pins/chatuchak-weekend-market) | Shopping (the one to plan around) | Saturday and Sunday, morning before it gets unbearable | Hot, crowded, big. Take the MRT to Kamphaeng Phet |
| [Yaowarat / Chinatown](/pins/yaowarat-bangkok-chinatown) | Eating | Evening | One of the best street-food scenes in Asia after dark. MRT Wat Mangkon |

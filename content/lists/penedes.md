...
#     · vilafranca-del-penedes (the still-wine capital town)
#     · codorniu-cellars (Sant Sadurní, Puig i Cadafalch modernist
#       cellar, the big visitor experience)
#     · freixenet (Sant Sadurní, the other industrial cava heavyweight)
#     · torres-pacs-del-penedes (still + cava, the train-through-the-
...
#
# - Spain country page already exists. City page for Penedès does not.
#   The intro mentions Penedès as plain text until /cities/penedes is
#   created, then swap to a link.
#
# - SEO title pattern follows the audited Semrush model: "[Region]
#   travel guide: [hook A], [hook B], [hook C]" where the hooks pull
#   from the top-volume keywords (cava tours from Barcelona 90/mo,
#   penedes 390/mo, wine country near Barcelona 20/mo, vilafranca del
#   penedes 90/mo).
---
...
* [How do I get to the wineries?](#how-do-i-get-to-the-wineries)
* [Top producers to book](#top-producers-to-book)
...
|---|---|---|---|---|---|---|
| Codorníu | Sant Sadurní d'Anoia. Industrial-scale cava, modernist cellar building by Puig i Cadafalch (a contemporary of Gaudí) | Mon-Fri 9:30 to 16:30. Sat-Sun + holidays 9:30 to 13:00 | 90-min Discovery Tour: garden + museum walk, electric train ride through the underground cellars, 2 cava tastings. Iconic Tour adds a third cava paired with chocolates | Catalan 11:15, Spanish 12:00 and 15:00, English 13:00 and 15:30 | Discovery ~€32, Iconic ~€38, Heritage "Memoria de la burbuja" €38 | The canonical first cava visit. Big tour groups. The architecture (one of the major modernist sites outside Barcelona) is the reason to come |

...
guide_cards:
  ...
  intro: Argentina's second city sits in the interior, founded in 1573, and most international travelers route through Buenos Aires to get here. The centre is a college town that runs late, the old plazas and Jesuit Block are walkable in a morning, and the Sierras de Córdoba sit an hour out for weekend escapes.
  cards:
    - title: Getting here is the catch
      body: Most international travelers connect via Buenos Aires (AEP or EZE). Direct foreign service is short, Panama City and a handful of regional South American routes; otherwise expect a stop.
    - title: A 500-year-old centre
      body: Founded 1573 around what is now Plaza San Martín. The UNESCO Jesuit Block, three or four central plazas, and a cluster of churches and the Cabildo cover a comfortable morning on foot.
    - title: It runs late
      body: Córdoba skews young in the centre. Dinner is 10 p.m., bars get going at 2 a.m., and it is not unusual to see groups walking home at 6 or 7 in the morning. Families largely live in gated suburbs.
    - title: The Sierras are an hour out
      body: Villa Carlos Paz is the weekend destination most Cordobeses head to. Smaller towns like La Cumbre and La Cumbrecita give you German-Argentine alpine pace. Plan a day around the drive.
...
faqs:
  ...
  - q: Where is it worth staying?
    a: Stay in or just south of the historic centre. Nueva Córdoba is the university neighborhood and the one most travelers default to; it puts you next to the nightlife, the cafes, and the walk into the old town. Holiday Inn Córdoba and Hotel NH Panorama are practical chains in this area.
  ...
  - q: How does Córdoba compare to Buenos Aires?
    a: Smaller, older, less polished, less expensive. The centre feels collegiate rather than cosmopolitan. The food scene is solid but quieter than Buenos Aires; the colonial and Jesuit history is denser. Most travelers do not need both on the same trip.
...
# - Saved_list housekeeping done 2026-05-11:
#     · Deleted duplicate empty list "cordoba - ar food".
#     · Created airport pin: cordoba-airport-cor.
#     · Populated "cordoba" saved_list with all Córdoba (Argentina)
#       pins (~60+ restaurants, attractions, hotels, sierras spots).
#     · Removed Spain false-positives that matched on the bare
#       "Córdoba" city_name: caliphate-city-of-medina-azahara,
...
#   (Jesuit Block centerpiece), Plaza San Martín, Villa Carlos Paz
#   city page or anchor pin. Currently mentioned as plain text.
#
# - Mike's saved Cordoba list is dense (~60 restaurants). The
#   prose surfaces five or six picks; the rest render on the cards/
#   map view at /lists/cordoba so visitors who want more options
#   can browse below.
---
...
The [Aeropuerto Internacional Córdoba (COR)](/pins/cordoba-airport-cor) sits about ten kilometres north of the city centre. It is Argentina's third-busiest airport, but its international roster is short. The reliable foreign direct routes are Panama City on Copa, and rotating regional service from [Bogotá](/cities/bogota), Santo Domingo, and Brazilian hubs (São Paulo, Florianópolis). If your trip starts anywhere else, plan to connect through Buenos Aires.
...
The old centre is small and walkable. The anchor is Plaza San Martín, the colonial main square. The [Cabildo de Córdoba](/pins/cabildo-de-cordoba), the colonial-era town hall, sits on the plaza's western side; the Catedral de Córdoba sits next to it. The plaza is the easiest place to start because four or five of the main churches and museums are within a few blocks.

The [UNESCO Jesuit Block](/pins/jesuit-block-and-estancias-of-cordoba) is the historic highlight. It is the original Jesuit colonial complex: the Iglesia de la Compañía de Jesús, the old university (Universidad Nacional de Córdoba, founded 1613), the Colegio Nacional de Monserrat. The Block sits a few blocks south of Plaza San Martín and you can see the major buildings in about an hour.

The city has three or four main plazas worth walking through:

* **Plaza San Martín**: colonial centre, cathedral, Cabildo
...
* **Plaza Italia**: south of the centre in the Güemes area, near the markets and bars

The [Córdoba Botanical Garden](/pins/cordoba-botanical-garden) is the easy green stop in the centre. It is the right place to walk slowly with a thermos and drink some mate.
...
Córdoba is a college town. That is the dominant fact for anyone planning evenings here. Dinner reservations at 10 p.m. are normal. The bars do not really fill until midnight or 1 a.m. The full going-out cycle (locally "salir") ends around 6 or 7 a.m., and if you are staying in the centre it is normal to see students still walking home in the early morning. The energy is genuine and it is one of the more distinctive things about the city. Most older Cordobeses move out to gated suburbs in the hills when they start families, so the centre stays young by default.
...
Most Cordobeses leave the city on weekends and drive into the [Sierras de Córdoba](https://en.wikipedia.org/wiki/Sierras_de_C%C3%B3rdoba), the mountain range that runs north–south just west of the city. Three options most travelers consider:
...
* **La Cumbre**: about 90 minutes north into the higher Sierras. Quieter, older, walkable. [La Baguala in La Cumbre](/pins/la-baguala-la-cumbre) is a fair lunch on the way.
* **[La Cumbrecita](/pins/la-cumbrecita)**: about two and a half hours south-west. A small German-Argentine alpine village, car-free in the centre, walking trails and streams. Probably the prettiest of the three.

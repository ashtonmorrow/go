...
Sofia Sofia Airport (SOF) sits about 7 km east of the center and is one of the closer European airport approaches. The Metro Line 1 connects directly into town.

| Mode | Time | Cost | When to use |
|---|---|---|---|
| Metro Line 1 | 20 min | 1.60 BGN single | The default. Direct from Terminal 2 to Serdika (Sofia center). 1.60 BGN is essentially nothing |

...
#   Candidates: Valletta's bastions from across Marsamxetto Harbor at
...
#   standard for European destinations (center, neighborhood,
#   favorite, travelers). Maltese place names kept in the local
...
| [Sliema Ferry](/pins/sliema-ferry-terminal) (Marsamxetto) | Two-minute crossing of the harbor from Sliema to Valletta. Runs every 30 minutes | About €2.80 return | The faster Valletta-from-St-Julian's option than the bus |
...
2. [Upper Barrakka Gardens](/pins/upper-barrakka): the small viewing terrace over the Grand Harbor with the saluting battery directly below. Fire at noon daily. The view across to the [Three Cities](/pins/fort-st-angelo) is the photograph the city is built around.
...
4. [Fort St Elmo](/pins/fort-st-elmo) at the tip of the peninsula: the fortress that held the Great Siege at terrible cost. The National War Museum is now inside. The rooftop has the second great harbor view of the day.
...
The harbor-side neighborhoods on the other side of the Grand Harbor (Birgu, Senglea, Cospicua) are the older fortified towns the Knights used before they built Valletta. Less polished, fewer tourists, more daily Maltese life. The main visit is [Fort St Angelo](/pins/fort-st-angelo) in Birgu, the medieval-and-Knights stronghold that anchored the Great Siege from the harbor side. The walk along the [Birgu Waterfront](/pins/birgu-waterfront) past the marina is the slow part of the trip. The [Malta at War Museum](/pins/malta-at-war-museum) covers the World War II air-war and bomb-shelter side of the city's history.
...
[Mdina](/pins/mdina) is the small fortified medieval town in the interior, on a high point 30 minutes from St Julian's by bus or 20 by Uber. The walled core is car-free, about 250 residents inside the walls, and quieter than anything on the coast. Walk the perimeter on the ramparts for the view, see the cathedral, get a coffee on the small main square, then back out. About a two-hour visit. Pair it with the [Saint Agatha catacombs](/pins/saint-agatha-catacombs) just outside the walls if you have time.
...
The other planning consideration is the **bachelor and hen party crowd**. [Paceville](/pins/holiday-inn-express-malta), the nightlife strip directly inland from the St Julian's hotels, is a known stag-do destination for UK and European groups in summer. The clubs are loud and the streets around them at 2 a.m. are not the calm-weekend version. Seafront hotels insulate from the noise. You are a block from the strip rather than in it. If the crowd is a deal-breaker, travel outside peak summer or base in Sliema or Valletta.

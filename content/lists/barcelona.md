...
faqs:
  - q: How do I get from Barcelona-El Prat (BCN) to the city centre?
    a: Most central hotels are 15 to 25 minutes by Grab, Uber, or taxi depending on traffic. Rideshare pickup runs out of the airport parking garage and the exact spot has moved several times, so check the in-app pin before you wander outside. The black-and-yellow taxi rank straight outside arrivals works fine if rideshare is being weird. Metro L9 Sud is the cheapest option but requires a transfer to reach the centre, which is awkward with two suitcases.
  - q: Where should I stay in Barcelona for a first visit?
    a: Poblenou on the yellow metro line. Less tourist-centric food, calmer evenings, the Holiday Inn Express sits ~€100/night and a three-minute walk from the metro. The Four Points on the Rambla works if you want a central address. Skip Airbnb; Barcelona has been clamping down on short-term rentals for years.
...
|---|---|---|
| Grab / Uber | Easiest with luggage | Pickup is currently inside the airport parking garage. The location has moved several times over the years, so check the in-app pin before you wander outside |
| Official taxi | Late arrivals, larger parties | Black-and-yellow rank straight outside arrivals. No app needed |
| Metro L9 Sud | Cheapest | Requires a transfer to reach the centre. Bearable with a small bag, painful with two suitcases |

...
São Paulo São Paulo / Guarulhos International (the international gateway. CGH is the domestic alternative) (GRU) is served by two airports: Guarulhos (GRU) for international, 25 km north of the city, and Congonhas (CGH) for domestic, 8 km south. GRU is the gateway for almost every international traveler.

| Mode | Time | Cost | When to use |
|---|---|---|---|
| Airport Bus Service (ABS) line 257 | 45 to 75 min | BRL 49 | The default. Direct from GRU to Praça da República, Av. Paulista, and Jardins. Comfortable, frequent, air-conditioned |
...
| Property | Note |
|---|---|
| [Renaissance São Paulo Hotel](/pins/renaissance-sao-paulo-hotel) | 4/5 ⭐⭐⭐⭐ |

These are the hotels I have pinned from prior stays. Each links to the pin with the address and any notes.

## Where to eat

São Paulo food is the most international side in South America. The Japanese-Brazilian sushi scene (the largest outside Japan. Liberdade is the historic neighborhood), the rodízio-style churrascarias (Fogo de Chão being the global brand built here), the Peruvian-Brazilian cevicherias, the casual Italian (huge Italian-Brazilian immigration). The picks below cover the breadth.

| Spot | Rating |
|---|---|
| [Bullguer - Jardins](/pins/bullguer-jardins) | Pinned |
| [El Huarique - Cocina Peruana](/pins/el-huarique-cocina-peruana) | Pinned |
| [Fazenda Churrascada](/pins/fazenda-churrascada) | Pinned |
| [Fogo de Chão Jardins](/pins/fogo-de-chao-jardins) | Pinned |
| [Hi Pokee | Cerqueira César](/pins/hi-pokee-cerqueira-cesar) | Pinned |
| [Kaifu Asian Cuisine](/pins/kaifu-asian-cuisine) | Pinned |

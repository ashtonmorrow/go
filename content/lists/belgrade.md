...
Belgrade Nikola Tesla Airport (BEG) sits about 18 km west of the center. The A1 minibus is the simplest path in, with rideshare as the easier-with-luggage option.

| Mode | Time | Cost | When to use |
|---|---|---|---|
| A1 airport minibus | 30 to 40 min | 300 RSD single | The default. Direct to Slavija Square in the center. Runs every 30 minutes, last departure 23:00 from the airport |
